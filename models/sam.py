...
from models.utils import build_kwargs_from_config, get_device
...
def efficientvit_sam_l0(image_size: int = 512, **kwargs) -> EfficientViTSam:
    from models.backbone import efficientvit_backbone_l0
...
def efficientvit_sam_xl0(image_size: int = 1024, **kwargs) -> EfficientViTSam:
    from models.backbone import EfficientViTLargeBackbone
...
if __name__ == '__main__':
    ...
    model = efficientvit_sam_l0()
    y = model(batch_inputs, multimask_output=False)
    for i in y:
        print(i.shape)